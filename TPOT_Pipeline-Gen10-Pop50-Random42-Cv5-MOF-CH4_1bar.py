...
tpot_data = pd.read_csv('MOF_CH4_1BAR.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.006267580679971967
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=DecisionTreeRegressor(max_depth=4, min_samples_leaf=2, min_samples_split=16)),
    ZeroCount(),
    StackingEstimator(estimator=XGBRegressor(learning_rate=0.5, max_depth=2, min_child_weight=9, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.9000000000000001, verbosity=0)),
